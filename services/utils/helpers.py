...
from services.turn_based_conversation.input_device.microphone_input import (
    MicrophoneInput as TurnBasedMicrophoneInput,
)
from services.turn_based_conversation.output_device.speaker_output import (
...
def _create_microphone_input_and_speaker_output(
    microphone_class: typing.Type[TurnBasedMicrophoneInput],
    speaker_class: typing.Type[TurnBasedSpeakerOutput],
